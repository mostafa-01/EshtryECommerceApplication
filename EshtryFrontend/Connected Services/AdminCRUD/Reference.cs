...
namespace EshtryFrontend.AdminCRUD {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="AdminCRUD.IAdminCRUD")]
    public interface IAdminCRUD {
        ...
        bool AddItem(string tittle, string description, string image, int quantity, float price, string seller, int CategoryID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminCRUD/AddItem", ReplyAction="http://tempuri.org/IAdminCRUD/AddItemResponse")]
        System.Threading.Tasks.Task<bool> AddItemAsync(string tittle, string description, string image, int quantity, float price, string seller, int CategoryID);
        ...
        string EditItem(int id, string tittle, string description, string image, int quantity, float price, string seller, int CategoryID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdminCRUD/EditItem", ReplyAction="http://tempuri.org/IAdminCRUD/EditItemResponse")]
        System.Threading.Tasks.Task<string> EditItemAsync(int id, string tittle, string description, string image, int quantity, float price, string seller, int CategoryID);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAdminCRUDChannel : EshtryFrontend.AdminCRUD.IAdminCRUD, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AdminCRUDClient : System.ServiceModel.ClientBase<EshtryFrontend.AdminCRUD.IAdminCRUD>, EshtryFrontend.AdminCRUD.IAdminCRUD {
        ...
        public bool AddItem(string tittle, string description, string image, int quantity, float price, string seller, int CategoryID) {
            return base.Channel.AddItem(tittle, description, image, quantity, price, seller, CategoryID);
        }
        
        public System.Threading.Tasks.Task<bool> AddItemAsync(string tittle, string description, string image, int quantity, float price, string seller, int CategoryID) {
            return base.Channel.AddItemAsync(tittle, description, image, quantity, price, seller, CategoryID);
        }
        ...
        public string EditItem(int id, string tittle, string description, string image, int quantity, float price, string seller, int CategoryID) {
            return base.Channel.EditItem(id, tittle, description, image, quantity, price, seller, CategoryID);
        }
        
        public System.Threading.Tasks.Task<string> EditItemAsync(int id, string tittle, string description, string image, int quantity, float price, string seller, int CategoryID) {
            return base.Channel.EditItemAsync(id, tittle, description, image, quantity, price, seller, CategoryID);
        }
